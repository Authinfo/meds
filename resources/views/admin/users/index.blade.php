            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.user.fields.idtype') }}
                        </th>
                        <th>
                            {{ trans('cruds.user.fields.noid') }}
                        </th>
                        <th>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search" strict="true">
                                ...
                                @foreach(App\Models\User::IDTYPE_SELECT as $key => $item)
                        ...
                        <td>
                            <select class="search" strict="true">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach(App\Models\User::JK_SELECT as $key => $item)
                                    <option value="{{ $item }}">{{ $item }}</option>
                                @endforeach
                            </select>
                        </td>
                ...
                <tbody>
                    @foreach($users as $key => $user)
                        <tr data-entry-id="{{ $user->id }}">
                            ...
                            <td>
                                {{ App\Models\User::IDTYPE_SELECT[$user->idtype] ?? '' }}
                            </td>
                            <td>
                                {{ $user->noid ?? '' }}
                            </td>
                            ...
                            <td>
                                {{ App\Models\User::JK_SELECT[$user->jk] ?? '' }}
                            </td>
                            <td>
